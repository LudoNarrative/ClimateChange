	...
	*/
	var startGame = function(id) {
		...
		var gameResources = [
			...
			{
				id: "undergradDinner",
				aspFilepaths: ["GameGenerator/ASP_cleaned/games/dinner_1.lp",
...
"GameGenerator/ASP_cleaned/games/dinner_25.lp",],
			...
			{
				id: "undergradLecture",
				aspFilepaths: ["GameGenerator/ASP_cleaned/games/lecture_1.lp",
...
"GameGenerator/ASP_cleaned/games/lecture_25.lp",],
			...
			{
				id: "undergradDean",
				aspFilepaths: ["GameGenerator/ASP_cleaned/games/dean_1.lp",
