...
//================Functions for the graph UI=====================================
	...
	var content = {
		...
		"timeline_high" : {
			"text" : "<h3>High Temperature Change</h3><p>Carbon emissions continue rising through to mid-century. Population growth is high, with energy consumption growing to three times its current level. Oil use increases until 2070, and coal is used to generate a majority of the world's energy. Crop and grass areas continue to grow, and forested areas continue to decline.</p>",
			"beginScene" : "finalDinner",
			"artAccentSrc" : "",
			"climateFacts" : [{
